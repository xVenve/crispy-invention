...
def EE1plus1(c, cycles, test_iteration):
    output_file = open('./logs/output_evolution_strategy_5-20_2' + "_" + str(NUM_MOTOR) + "_" + str(cycles) + "_" + str(c) + "_" +
                       str(test_iteration) + '.txt', 'w')
    output_file2 = open('results10_2.txt', 'a')
    ...
    for i in range(0, cycles):
        ...
        if float(best_evaluation) == 0:
            break
    output_file2.write('output_evolution_strategy_5-20_2' + "_" + str(NUM_MOTOR) + "_" + str(cycles) + "_" + str(c) + "_" +
